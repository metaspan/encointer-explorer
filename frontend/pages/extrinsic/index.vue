...
import { useExtrinsicStore } from '~/stores/extrinsicStore';
...
query extrinsics($orderBy: [ExtrinsicOrderByInput!], $limit: Int!, $offset: Int!, $fromDate: DateTime!, $toDate: DateTime!) {
  extrinsicsConnection(orderBy: chainId_ASC, where: {AND: {timestamp_gte: $fromDate}, timestamp_lte: $toDate}) {
    totalCount
  }
